...
function Colors() {
  ...
  return (
    <section id="cores" className="bg-black py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mb-12">
          <div className="relative w-full max-w-3xl">
            <div className="relative flex items-center justify-center min-h-[500px]">
              {/* src procura dentro de colors uma por uma até encontrar o id selecionado e retorna a image */}
              <img
            ...
            <div className="absolute bottom-4 left-0 right-5 text-center">
        ...
        <div id="comprar" className="text-center mt-16">
          <a
            ...
            className="inline-block bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 shadow-md shadow-blue-500/50"
          >
            Compre agora a partir de R$ 99.999,00
          </a>

          <p className="mt-4 text-gray-400">
            Ou em até 12x de uma vida inteira sem juros
          </p>
        </div>
      </div>
    </section>
